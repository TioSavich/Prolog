...
### 4. Teacher (oracle_server.pl)
```prolog
% The teacher creates conditions for strategy emergence:
...
**Response**: Teacher intervention — conditions for a more efficient strategy  
...
**Response**: Teacher intervention — conditions for encountering the operation  
**Learn**: Strategy for subtract/multiply/divide  
...
- Teacher = **cultural authority** creating conditions for learning
- Real learning involves cultural transmission
- Not "magic" - legitimate knowledge source

### 3. Hermeneutic (Gadamer)
- The system receives **interpretations** not just results
- Understanding through encountering the practice, not being told the rule
...
% 3. Teacher creates conditions for crisis
...
✅ Encounters teacher intervention  
